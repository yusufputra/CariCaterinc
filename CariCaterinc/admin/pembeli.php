          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                $query2     = $DB_conn->query("SELECT * FROM `user` WHERE `seller` = '0'");
                ...
                for ($i=0; $i < $row2; $i++) {?> 
                  ...
                  <td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <!-- <li><a href="?page=editbuyer&id=<?php //echo $result2[$i]['id']; ?>">Edit</a></li> -->
                        <li><a href="?page=delete-buyer&id=<?php echo $result2[$i]['id']; ?>">Hapus</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
