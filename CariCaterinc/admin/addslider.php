...
//echo var_dump($result);
   ...
   if($user->addslider($target_dir_up,$target_dir,$target_file_up,$target_file,$file,$file_tmp,$file_size,$uploadOk,$imageFileType,$judul)){
    ?>
    
    <script type="text/javascript">
    window.location.href = '?page=slider&added';
    </script><?php
