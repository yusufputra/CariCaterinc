...
<div class="container" style="background-color:#eee;  margin-top:30px; margin-bottom:0px; padding:20px">
  ...
  <?php
            ...
            {
                 ?>
                 <p style="color:#F9AE2C">Menu berhasil ditambahkan!</p>
      ...
      <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label class="col-md-3 control-label text-right">Foto Produk</label>
            <div class="col-md-7">
              <input type="file" name="gambar" class="form-control" style="width:230px">
            </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-md-3 control-label text-right">Min Order</label>
            <div class="col-md-2">
              <input class="form-control" type="text" name="minor" value=" " style="width:180px; " required>
            </div>
        ...
        <div class="form-group">
          <label class="col-md-3 control-label text-right">Harga Satuan</label>
            <div class="col-md-7">
              <input class="form-control" name="harga" type="text" style="width:180px; " reuired>
            </div>
        </div>
        <div class="form-group">
